            ...
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="stat-card">
                        ...
                        <div class="stat-label text-primary"><i class="bi bi-hash me-2"></i> Strand Code</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat-card">
                        ...
                        <tbody>
                            <?php if ($students_result->num_rows > 0): ?>
                                <?php while ($student = $students_result->fetch_assoc()): ?>
                                    <tr>
                                        <td><i class="bi bi-person me-3"></i> <?= htmlspecialchars($student['fname'] . ' ' . $student['lname']) ?></td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr>
                                    <td class="text-muted">No students are enrolled in this strand.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <?php if ($materials_result->num_rows > 0): ?>
                                <?php while ($material = $materials_result->fetch_assoc()): ?>
                                    <tr>
                                        <td><i class="bi bi-file-earmark-text me-3"></i> <?= htmlspecialchars($material['label']) ?> (<?= htmlspecialchars($material['type']) ?>)</td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr>
                                    <td class="text-muted">No materials have been added to this strand.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <?php if ($assessments_result->num_rows > 0): ?>
                                <?php while ($assessment = $assessments_result->fetch_assoc()): ?>
                                    <tr>
                                        <td><i class="bi bi-clipboard-check me-3"></i> <?= htmlspecialchars($assessment['title']) ?></td>
                                    </tr>
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr>
                                    <td class="text-muted">No assessments have been created for this strand.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
